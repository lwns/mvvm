package com.core.op.lib.bindingadapter.common;

/**
 * Unify {@link com.core.op.lib.bindingadapter.common.ItemView} and {@link ItemViewSelector} to simplify BindingAdapters.
 */
public class ItemViewArg<T> {
    public static <T> ItemViewArg<T> of(com.core.op.lib.bindingadapter.common.ItemView itemView) {
